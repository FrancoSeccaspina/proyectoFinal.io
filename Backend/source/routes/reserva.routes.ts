...
// Rutas del reservas
route.get("/reserva/mostrar/ultimaReserva", verificarTokenPorRol([Roles.CLIENTE, Roles.ADMIN]), (req: Request, res: Response) => { reservaController.mostrarUltimaReserva(req, res) });
